...
class ServiceController extends Controller
{
    ...
    public function airtable()
    {
        ...
        do {
            ...
            foreach ( $airtable_response['records'] as $record ) {
                ...
                $service->service_url = str_replace("https://","",$service->service_url);
                $service->service_url = str_replace("http://","",$service->service_url);
    ...
    {
        $chip_name = Taxonomy::find($id)->taxonomy_name;
