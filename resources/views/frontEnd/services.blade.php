            ...
            <div class="col-md-8 pt-15 pr-0">
                ...
                <div class="panel content-panel">
                    <div class="panel-body p-20">
                        ...
                        @foreach($service->taxonomy as $service_taxonomy)
                         <a class="panel-link" href="/category_{{$service_taxonomy->taxonomy_recordid}}">{{$service_taxonomy->taxonomy_name}},</a>
                        @endforeach
                        </h4>
                        @endif
                        ...
                        @foreach($service->organization as $service_organization)
                        
                        <a class="panel-link" href="/organization_{{$service_organization->organization_recordid}}"> {{$service_organization->organization_name}}</a>
                        @endforeach
                        </h4>
                        @endif
