            ...
            <div class="col-md-8 pt-15 pr-0">
                ...
                <div class="panel ml-15 mr-15">
                    <div class="panel-body p-20">
                        ...
                        <h4 class="panel-text" style="word-wrap: break-word;"><span class="badge bg-blue" >Url:</span><a target="_blank" href="http://{{$service->service_url}}" > {!! $service->service_url !!}</a></h4>
